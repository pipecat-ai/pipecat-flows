...
def create_continued_customer_interaction_node() -> NodeConfig:
    ...
    return NodeConfig(
        ...
        task_messages=[
            {
                "role": "developer",
                "content": """Ask the customer if there's anything else you could help them with today, or if they'd like to end the conversation. If they need more help, re-offer the two choices you offered before: you could provide store location and hours of operation, or begin placing an order.
